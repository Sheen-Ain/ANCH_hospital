...
@media(max-width:900px) { .stats-grid-r { grid-template-columns:repeat(2,1fr); } }
@media(max-width:480px) { .stats-grid-r { grid-template-columns:1fr 1fr; gap:.625rem; } }
...
.stat-card-r.sc-blue::after   { background:var(--color-primary); }
.stat-card-r.sc-green::after  { background:#059669; }
.stat-card-r.sc-amber::after  { background:#d97706; }
.stat-card-r.sc-slate::after  { background:#64748b; }
.stat-card-r:hover { box-shadow:var(--shadow-md); }
...
.sc-blue  .stat-icon-r { background:var(--color-primary-lt); color:var(--color-primary); }
.sc-green .stat-icon-r { background:#d1fae5; color:#059669; }
.sc-amber .stat-icon-r { background:#fef3c7; color:#d97706; }
.sc-slate .stat-icon-r { background:#f1f5f9; color:#64748b; }
...
.stat-label-r { font-size:11px; color:var(--color-text-muted); margin-top:2px; font-weight:500; }
.stat-sub-r {
    font-size:11px; font-weight:600; margin-top:5px;
    display:inline-flex; align-items:center; gap:4px;
    padding:2px 7px; border-radius:20px;
}
.sc-blue  .stat-sub-r { background:var(--color-primary-lt); color:var(--color-primary); }
.sc-green .stat-sub-r { background:#d1fae5; color:#059669; }
.sc-amber .stat-sub-r { background:#fef3c7; color:#d97706; }
.sc-slate .stat-sub-r { background:#f1f5f9; color:#64748b; }
...
@keyframes shimmerR { to { background-position:-200% 0; } }
...
.r-drop-item:hover { background:var(--color-surface); }
.r-drop-icon {
...
.r-drop-tooltip::before {
    ...
    border:4px solid transparent; border-right-color:#1e293b; border-left:none;
}
.r-drop-item:hover .r-drop-tooltip { opacity:1; }
.r-drop-divider { border:none; border-top:1px solid var(--color-border); margin:4px 0; }
...
@media(max-width:700px) { .gt-modal-body-r { grid-template-columns:1fr; max-height:none; } }

.gt-doctor-grid-r {
    display:grid; grid-template-columns:1fr 1fr; gap:.625rem;
    overflow-y:auto; max-height:58vh; padding-right:4px;
}
@media(max-width:500px) { .gt-doctor-grid-r { grid-template-columns:1fr; } }
...
.gt-doc-card-r:hover  { border-color:var(--color-primary); background:var(--color-primary-lt); }
...
.gt-doc-card-r.full { opacity:.45; cursor:not-allowed; pointer-events:none; }
.gt-doc-name-r { font-size:12px; font-weight:700; color:var(--color-text); margin-bottom:2px; }
.gt-doc-spec-r { font-size:11px; color:var(--color-text-muted); }
.gt-doc-fee-r  { font-size:11px; font-weight:600; color:var(--color-accent); margin-top:5px; }
.gt-doc-tok-r  {
    font-family:'JetBrains Mono',monospace;
    font-size:12px; font-weight:800; color:var(--color-primary); margin-top:2px;
}
.gt-check-r {
...
.gt-doc-card-r.selected .gt-check-r { display:flex; }
...
.gt-token-preview-r.inactive { background:linear-gradient(135deg,#475569,#64748b); }
.gt-token-preview-r::before {
    content:''; position:absolute; width:120px; height:120px; border-radius:50%;
    background:rgba(255,255,255,.06); top:-30px; right:-30px;
}
.gt-tp-label-r { font-size:10px; font-weight:700; text-transform:uppercase;
...
.gt-tp-doc-r  { font-size:11px; color:rgba(255,255,255,.8); margin-top:6px; }
.gt-tp-date-r { font-size:10px; color:rgba(255,255,255,.55); margin-top:3px; }

.gt-form-grid-2-r { display:grid; grid-template-columns:1fr 1fr; gap:.75rem; }
@media(max-width:460px) { .gt-form-grid-2-r { grid-template-columns:1fr; } }
...
.gt-section-label-r i { color:var(--color-primary); font-size:10px; }
.gt-section-label-r:first-child { margin-top:0; }

.gt-right-panel-r { overflow-y:auto; max-height:58vh; padding-right:2px; }
@media(max-width:700px) { .gt-right-panel-r { max-height:none; } }

/* ── Table responsive ── */
.patients-table-wrap-r { overflow-x:auto; -webkit-overflow-scrolling:touch; }
#rPatientsTable { width:100%; border-collapse:collapse; }
@media(max-width:960px) { .col-hide-md-r { display:none !important; } }
@media(max-width:640px) { .col-hide-sm-r { display:none !important; } }

/* ── Pagination ── */
.pagination-row-r {
    display:flex; align-items:center; justify-content:space-between;
    gap:.75rem; flex-wrap:wrap;
    padding:.625rem 1rem; border-top:1px solid var(--color-border);
    font-size:12px; color:var(--color-text-muted);
}
.per-page-wrap-r { display:flex; align-items:center; gap:.5rem; }
.per-page-wrap-r select {
    font-size:12px; padding:3px 8px;
    border:1px solid var(--color-border); border-radius:6px;
    background:var(--color-surface); color:var(--color-text); cursor:pointer;
}
.page-btns-wrap-r { display:flex; align-items:center; gap:.25rem; flex-wrap:wrap; }
.r-page-btn {
...
.r-page-btn:hover:not(:disabled) { background:var(--color-primary-lt); border-color:var(--color-primary); color:var(--color-primary); }
.r-page-btn.active { background:var(--color-primary); border-color:var(--color-primary); color:#fff; font-weight:700; }
.r-page-btn:disabled { opacity:.4; cursor:not-allowed; }
.r-page-btn.dots { cursor:default; border-color:transparent; background:transparent; }

/* ── Edit modal ── */
.ep-form-grid-2 { display:grid; grid-template-columns:1fr 1fr; gap:.75rem; }
@media(max-width:480px) { .ep-form-grid-2 { grid-template-columns:1fr; } }

/* ── Charge Selector (shared with admin, prefixed rCds) ── */
...
<div class="stats-grid-r" id="rStatsGrid">
    <div class="stat-card-r sc-blue">
        ...
        <div class="stat-body" style="flex:1;min-width:0;">
            <div class="stat-value-r" id="rStatTotal"><div class="stat-skeleton-r" style="width:40px;"></div></div>
    ...
    <div class="stat-card-r sc-green">
        ...
        <div class="stat-body" style="flex:1;min-width:0;">
            <div class="stat-value-r" id="rStatRevenue"><div class="stat-skeleton-r" style="width:70px;"></div></div>
    ...
    <div class="stat-card-r sc-amber">
        ...
        <div class="stat-body" style="flex:1;min-width:0;">
            <div class="stat-value-r" id="rStatPending"><div class="stat-skeleton-r" style="width:70px;"></div></div>
    ...
    <div class="stat-card-r sc-slate">
        ...
        <div class="stat-body" style="flex:1;min-width:0;">
            <div class="stat-value-r" id="rStatReturned"><div class="stat-skeleton-r" style="width:30px;"></div></div>
        ...
        <div class="modal-body" style="padding:1rem;">
            ...
            <div class="gt-modal-body-r">
                ...
                <div class="gt-right-panel-r">
                    ...
                    <input type="hidden" id="rGtChargesJson" value="[]">
                    <div class="cds-wrapper mb-3" id="rGtCdsWrapper">
                        <div class="cds-trigger" id="rGtCdsTrigger" onclick="rCds.toggle()">
                            <div id="rGtCdsPills"><span class="cds-placeholder">Loading charges…</span></div>
                            <span class="cds-caret"><i class="fa-solid fa-chevron-down"></i></span>
                        </div>
                        <div class="cds-panel" id="rGtCdsPanel">
                            <div class="cds-add-row">
                                <input type="text" class="cds-add-input" id="rGtCdsNewName" placeholder="Charge name" autocomplete="off">
                                <input type="number" class="cds-add-input amt" id="rGtCdsNewAmt" placeholder="Rs." min="0" step="0.01">
                                <button type="button" class="cds-add-btn" onclick="rCds.addNew()">
                                    <i class="fa-solid fa-plus"></i> Add
                                </button>
                            </div>
                            <div class="cds-add-err" id="rGtCdsAddErr" style="display:none;">
                                <i class="fa-solid fa-circle-xmark"></i><span></span>
                            </div>
                            <div class="cds-list" id="rGtCdsList"></div>
                            <div class="cds-total-row">
                                <span><i class="fa-solid fa-sigma" style="font-size:10px;margin-right:3px;"></i>Total</span>
                                <span class="cds-total-amt" id="rGtCdsTotal">Rs. 0</span>
                            </div>
                        </div>
                    </div>
...
(function () {
    ...
    // ════════════════════════════════════════════════════════════
    // CHARGE SELECTOR (rCds) — receptionist version (no edit/delete)
    // ════════════════════════════════════════════════════════════
    window.rCds = (function () {
        let charges   = [];
        ...
        function fmt(n) {
            return currSym + ' ' + parseFloat(n).toLocaleString('en-PK', {minimumFractionDigits:2,maximumFractionDigits:2});
        }
        ...
        function syncJson() {
            document.getElementById('rGtChargesJson').value = JSON.stringify(getSelected());
            const total = getSelected().reduce((s, c) => s + c.amount, 0);
            document.getElementById('rGtCdsTotal').textContent = fmt(total);
            renderPills();
        }

        function renderPills() {
            const box   = document.getElementById('rGtCdsPills');
            ...
            box.innerHTML = items.map(c =>
                `<span class="cds-pill">${escHtml(c.name)}
                    <span class="cds-pill-x" onclick="event.stopPropagation();rCds.deselect('${escHtml(c.name)}')">
        ...
        function toggleItem(id) {
            ...
            // Update in-place — avoid full re-render which detaches e.target
            const el = document.getElementById(`rcitem-${id}`);
            if (el) {
        ...
        function deselect(name) {
            const c = charges.find(x => x.name === name);
            if (!c || c.is_opd) return;
            selected.delete(c.id); render();
        }

        function addNew() {
            const nameEl = document.getElementById('rGtCdsNewName');
            const amtEl  = document.getElementById('rGtCdsNewAmt');
            const errEl  = document.getElementById('rGtCdsAddErr');
            const name   = nameEl.value.trim();
            const amt    = amtEl.value.trim();

            const showErr = msg => { errEl.style.display='flex'; errEl.querySelector('span').textContent=msg; };
            ...
            const btn = document.querySelector('#rGtCdsPanel .cds-add-btn');
            const origHtml = btn.innerHTML;
            btn.innerHTML = '<span class="spinner" style="width:12px;height:12px;"></span>';
            btn.disabled  = true;

            const fd = new FormData();
            fd.set('action','addCharge'); fd.set('csrf_token',getCsrfToken());
            fd.set('name',name); fd.set('amount',amt);
            ...
            fetch(AJAX_URL, {method:'POST',body:fd})
                ...
                .catch(() => { btn.innerHTML=origHtml; btn.disabled=false; showErr('Network error.'); });
        }

        function toggle() {
            isOpen = !isOpen;
            document.getElementById('rGtCdsTrigger').classList.toggle('open', isOpen);
            document.getElementById('rGtCdsPanel').classList.toggle('open', isOpen);
            if (isOpen) document.getElementById('rGtCdsNewName').focus();
        }

        function reset() {
            selected.clear();
            charges.forEach(c => { if (c.is_opd) selected.add(c.id); });
            doctorFee = 0; isOpen = false;
            document.getElementById('rGtCdsTrigger')?.classList.remove('open');
            document.getElementById('rGtCdsPanel')?.classList.remove('open');
            render();
        }

        document.addEventListener('click', e => {
            if (isOpen && !document.getElementById('rGtCdsWrapper')?.contains(e.target)) {
                isOpen = false;
                document.getElementById('rGtCdsTrigger')?.classList.remove('open');
                document.getElementById('rGtCdsPanel')?.classList.remove('open');
            }
        ...
        return { load, setDoctorFee, toggleItem, deselect, addNew, toggle, reset };
    })();
    ...
    document.getElementById('rOpenGenTokenBtn').addEventListener('click', () => {
        ...
        rLoadGtDoctors();
        if (!rCds._loaded) { rCds.load(); rCds._loaded = true; }
        else rCds.reset();
    });
    ...
    function rRefreshToken() {
        ...
        fetch(`${AJAX_URL}?${new URLSearchParams({ action:'getNextToken', doctor_id:rGt.docId, visit_date:visitDate })}`)
            ...
            .then(res => {
                ...
                rCds.setDoctorFee(res.data.fee);
    ...
    function rSubmitToken() {
        ...
        fd.set('payment_status',  payStatus);
        fd.set('extra_charges_json', document.getElementById('rGtChargesJson').value);
        if (payStatus === 'paid') fd.set('payment_method', method);
