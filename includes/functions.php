...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .receipt-section-title i { font-size: 10px; }
  ...
  .status-paid   i { color: #059669; }
  .status-unpaid i { color: #d97706; }
  ...
  /* ── Print styles — 58mm thermal receipt printer ── */
  @media print {
    @page {
      size: 58mm auto;   /* narrow thermal receipt */
      margin: 2mm 3mm;
    }
...
<div class="receipt-wrapper">
  ...
  <div class="token-box">
    ...
    <div class="token-sub">
      ...
      Serial <?= (int) $row['serial_number'] ?> &nbsp;&bull;&nbsp;
      <i class="fa-solid fa-user-doctor" style="font-size:10px;"></i>
      Dr. <?= e($row['doctor_name']) ?>'s Queue
    </div>
  </div>
  ...
  <table class="info-table">
    ...
    <?php if ($row['phone']): ?>
    <tr>
      <td class="lbl"><i class="fa-solid fa-phone"></i> Phone</td>
      <td class="val"><?= e($row['phone']) ?></td>
    </tr>
    <?php endif; ?>
    <?php if ($row['address']): ?>
    <tr>
      <td class="lbl"><i class="fa-solid fa-location-dot"></i> Address</td>
      <td class="val" style="font-weight:400;font-size:11px;"><?= e($row['address']) ?></td>
    </tr>
    <?php endif; ?>
  </table>
  ...
  <table class="info-table">
    <tr>
      ...
      <td class="val">Dr. <?= e($row['doctor_name']) ?></td>
    </tr>
    <tr>
      <td class="lbl"><i class="fa-solid fa-stethoscope"></i> Specialty</td>
      <td class="val"><?= e($row['specialization']) ?></td>
    </tr>
    <tr>
      <td class="lbl"><i class="fa-regular fa-calendar"></i> Date</td>
      <td class="val"><?= formatDate($row['visit_date']) ?></td>
    </tr>
    <tr>
      <td class="lbl"><i class="fa-regular fa-clock"></i> Time</td>
      <td class="val"><?= formatTime($row['visit_time']) ?></td>
    </tr>
  </table>
  ...
  <table class="info-table">
    <tr>
      ...
      <td class="val"><?= formatCurrency((float)($row['amount'] ?? 0)) ?></td>
    </tr>
    <tr>
      <td class="lbl"><i class="fa-solid fa-circle-info"></i> Status</td>
      <td>
        <?php if ($isPaid): ?>
    ...
    <?php if ($isPaid && $row['payment_method']): ?>
    <tr>
      <td class="lbl"><i class="fa-solid fa-credit-card"></i> Method</td>
      <td class="val"><?= ucfirst(e($row['payment_method'])) ?></td>
    </tr>
    <?php endif; ?>
    <tr>
      <td class="lbl"><i class="fa-solid fa-receipt"></i> Receipt #</td>
      <td class="val" style="font-family:monospace;font-size:11px;"><?= e($receiptNum) ?></td>
    </tr>
  </table>
  ...
  <div class="receipt-footer">
    ...
    <p style="margin-top:4px;font-size:10px;letter-spacing:0.05em;">— TokenMed —</p>
  </div>
  ...
  <div class="urdu-section">
    ...
    <!-- Only numeric/universal fields — no transliteration of names -->
    <table class="urdu-table">
      ...
      <tr>
        <td class="u-val" style="direction:ltr;text-align:right;"><?= formatDate($row['visit_date']) ?></td>
        <td class="u-lbl">تاریخ</td>
      </tr>
      <tr>
        <td class="u-val" style="direction:ltr;text-align:right;"><?= formatTime($row['visit_time']) ?></td>
        <td class="u-lbl">وقت</td>
      </tr>
      <tr>
        <td class="u-val"><?= formatCurrency((float)($row['amount'] ?? 0)) ?></td>
    ...
    <div style="text-align:center;margin-top:10px;font-size:11px;color:#94a3b8;
                font-family:'Plus Jakarta Sans',sans-serif;direction:ltr;">
      — TokenMed —
    </div>
  </div>
  <?php endif; ?>
...
.slip-logo i   { font-size: 28px; color: #0369a1; }

.slip-header-text { flex: 1; }
.slip-header-text h1 { font-size: 18px; font-weight: 800; color: #0369a1; margin-bottom: 2px; }
.slip-header-text h2 { font-size: 12px; font-weight: 700; text-transform: uppercase;
                       letter-spacing: 2px; color: #64748b; margin-bottom: 4px; }
.slip-header-text p  { font-size: 11px; color: #94a3b8; margin: 1px 0; }
...
.slip-ref-num {
    font-size: 20px; font-weight: 800; color: #0369a1;
    font-family: 'Courier New', monospace;
}
.slip-ref-date { font-size: 11px; color: #64748b; margin-top: 2px; }
...
.status-discharged { background: #f0fdf4; color: #166534; }
...
.slip-section-title i { font-size: 11px; color: #0369a1; }
...
.info-label {
    ...
    letter-spacing: 0.06em; color: #94a3b8; margin-bottom: 1px;
}
.info-value {
...
.fin-table td { padding: 5px 0; font-size: 13px; vertical-align: middle; }
.fin-table td:last-child { text-align: right; font-weight: 600; }
.fin-table .fin-lbl { color: #64748b; }
.fin-table .fin-lbl i { font-size: 11px; margin-right: 4px; color: #94a3b8; }
.fin-total td { border-top: 2px solid #0369a1; padding-top: 8px; font-weight: 800; color: #0369a1; font-size: 14px; }
...
@media print {
    ...
    .slip-wrapper { max-width: 100% !important; }
